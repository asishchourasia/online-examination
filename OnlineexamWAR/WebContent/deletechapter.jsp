...
function validation()
{
	...
	if(document.getElementById("chapterid").value=='')
	{
		alert("please enter chapter id");
 ...
 <tr>
    <td width="165" valign="top" id="navborder"><br />
      <table width="191" border="0" cellpadding="0" cellspacing="0" id="navigation">
        ...
        <tr>
          <td><a href="ViewuserServlet" class="navText"><strong>VIEW STUDENTS DETAILS</strong></a></td>
        </tr>
        <tr>
          <td><a href="ViewstudentscoreServlet" class="navText"><strong>VIEW STUDENTS'S SCORE</strong></a></td>
        </tr>
      </table></td>
	...
	&nbsp;<br />
  	<table border="0" cellspacing="0" cellpadding="0" width="305">
        <tr>
          <td class="pageName"><p>DELETE CHAPTER</p>
          <p>&nbsp;</p>
          <p>&nbsp; </p></td>
        </tr>
        <tr>
          <td class="bodyText">
          <form id="form1" name="form1" method="post" onsubmit=" return validation()" action="DeletechapterServlet">
            <label><strong>Enter Chapter ID</strong>
