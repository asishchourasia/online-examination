 ...
 <tr>
    <td width="165" valign="top" id="navborder"><br />
      <table width="191" border="0" cellpadding="0" cellspacing="0" id="navigation">
        <tr>
          <td width="191"><a href="ChangeadminpasswordServlet" class="navText style2">CHANGE PASSWORD </a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><a href="ViewstudentscoreServlet" class="navText"><strong>VIEW STUDENT'S SCORES</strong></a></td>
        </tr>
      </table></td>
	...
	&nbsp;<br />
  	<table border="0" cellspacing="0" cellpadding="0" width="305">
        <tr>
          <td class="pageName">TEST MANAGEMENT </td>
        </tr>
        <tr>
	  ...
	  &nbsp;  &nbsp;</p>
	  <p><br />
      <span class="style1"><a href="LinkaddchapterServlet"><b>1) ADD QUESTIONS </b></a></span></p>
	  <p>&nbsp;</p>
	  <p class="style4"><a href="EditallquestionsServlet" class="style5">2) EDIT QUESTIONS </a> </p>
      <p class="style4"></p></td>
    <td width="50"><img src="mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
